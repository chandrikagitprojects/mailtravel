Feature: User should able to verify confirm details and book now Successfully

  Scenario: Verify confirm details and book now Successfully with valid credentials
    ...
    And user check by click on Book Now button
